...
const Filter = ({
  ...
  return (
    <article className="flex flex-col items-center">
      ...
      <ul
        className={
          "max-w-[192px] w-full transition-all bg-white rounded-[6px] p-6 absolute shadow-[0_35px_60px_-15px_rgba(72,84,159,0.25)] opacity-0 dark:shadow-[0_35px_60px_-15px_rgba(0, 0, 0, 0.25)] translate-y-[50px] dark:bg-lightBlue transition-all flex flex-col gap-2 " +
